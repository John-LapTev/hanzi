export const APP_VERSION = 'hanzi-v79';   // версия обязана совпадать с CACHE в sw.js
export const AUDIO_CACHE = 'hanzi-audio'; // имя кеша записей — такое же в sw.js

/* ═══════════════════ Константы ═══════════════════ */

export const DB_NAME = 'hanzi';
export const DB_VERSION = 2;      // 2 — добавлено хранилище прогресса по слогам
