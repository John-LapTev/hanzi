...
/** Пять проходов по слову — от узнавания к самостоятельной речи, в этом порядке. */
export const HARD_MODES = [
  { id: 'write', icon: '写', title: 'Как пишется',
    note: 'Смотришь анимацию: в каком порядке идут черты.' },
  { id: 'choice', icon: '选', title: 'Выбрать из четырёх',
    note: 'Русский на карточке — выбираешь нужный иероглиф.' },
  { id: 'typeHanzi', icon: '汉', title: 'Написать иероглифами',
    note: 'Русский на карточке — набираешь слово по-китайски.' },
  { id: 'typeRu', icon: '译', title: 'Написать перевод',
    note: 'Иероглифы на карточке — набираешь перевод по-русски.' },
  { id: 'speak', icon: '声', title: 'Сказать вслух',
    note: 'Русский на карточке — говоришь по-китайски, запись сверяется с образцом.' },
];
...
/** Общая шкала раздела: каждое слово должно пройти все пять режимов. */
